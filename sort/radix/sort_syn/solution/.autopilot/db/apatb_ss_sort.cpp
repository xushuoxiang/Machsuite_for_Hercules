...
// wrapc file define:
#define AUTOTB_TVIN_a "../tv/cdatafile/c.ss_sort.autotvin_a.dat"
#define AUTOTB_TVOUT_a "../tv/cdatafile/c.ss_sort.autotvout_a.dat"
// wrapc file define:
#define AUTOTB_TVIN_b "../tv/cdatafile/c.ss_sort.autotvin_b.dat"
#define AUTOTB_TVOUT_b "../tv/cdatafile/c.ss_sort.autotvout_b.dat"
// wrapc file define:
#define AUTOTB_TVIN_bucket "../tv/cdatafile/c.ss_sort.autotvin_bucket.dat"
#define AUTOTB_TVOUT_bucket "../tv/cdatafile/c.ss_sort.autotvout_bucket.dat"
// wrapc file define:
#define AUTOTB_TVIN_sum "../tv/cdatafile/c.ss_sort.autotvin_sum.dat"
#define AUTOTB_TVOUT_sum "../tv/cdatafile/c.ss_sort.autotvout_sum.dat"
// wrapc file define:
#define AUTOTB_TVIN_checkdata "../tv/cdatafile/c.ss_sort.autotvin_checkdata.dat"
#define AUTOTB_TVOUT_checkdata "../tv/cdatafile/c.ss_sort.autotvout_checkdata.dat"
// wrapc file define:
#define AUTOTB_TVIN_hercules_buffer_size "../tv/cdatafile/c.ss_sort.autotvin_hercules_buffer_size.dat"
#define AUTOTB_TVOUT_hercules_buffer_size "../tv/cdatafile/c.ss_sort.autotvout_hercules_buffer_size.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_a "../tv/rtldatafile/rtl.ss_sort.autotvout_a.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_b "../tv/rtldatafile/rtl.ss_sort.autotvout_b.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_bucket "../tv/rtldatafile/rtl.ss_sort.autotvout_bucket.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_sum "../tv/rtldatafile/rtl.ss_sort.autotvout_sum.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_checkdata "../tv/rtldatafile/rtl.ss_sort.autotvout_checkdata.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_hercules_buffer_size "../tv/rtldatafile/rtl.ss_sort.autotvout_hercules_buffer_size.dat"
...
string get_depth_list () {
  ...
  total_list << "{bucket " << bucket_depth << "}\n";
...
extern "C" void ss_sort_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
extern "C" void apatb_ss_sort_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_bucket, volatile void * __xlx_apatb_param_sum, volatile void * __xlx_apatb_param_checkdata, volatile void * __xlx_apatb_param_hercules_buffer_size) {
    ...
    } // end post check logic bolck
  {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > b_pc_buffer(2048);
          int i = 0;
    ...
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_bucket);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > bucket_pc_buffer(2048);
          int i = 0;

          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            RTLOutputCheckAndReplacement(AESL_token, "bucket");
  
            // push token into output port buffer
            if (AESL_token != "") {
              bucket_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 2048; j < e; j += 1, ++i) {
            ((int*)__xlx_apatb_param_bucket)[j] = bucket_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
  {
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_sum);
        if (rtl_tv_out_file.good()) {
          rtl_tv_out_file >> AESL_token;
          if (AESL_token != "[[[runtime]]]")
            exit(1);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > sum_pc_buffer(128);
          int i = 0;

          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){

            RTLOutputCheckAndReplacement(AESL_token, "sum");
  
            // push token into output port buffer
            if (AESL_token != "") {
              sum_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (i > 0) {{
            ...
            ((int*)__xlx_apatb_param_sum)[j] = sum_pc_buffer[i].to_int64();
          }}}
        } // end transaction
      } // end file is good
    } // end post check logic bolck
...
//bucket
aesl_fh.touch(AUTOTB_TVIN_bucket);
aesl_fh.touch(AUTOTB_TVOUT_bucket);
//sum
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_b)[j];
  ...
  tcl_file.set_num(2048, &tcl_file.b_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_b, __xlx_sprintf_buffer.data());
}
unsigned __xlx_offset_byte_param_bucket = 0;
// print bucket Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_bucket, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_bucket = 0*4;
  if (__xlx_apatb_param_bucket) {
    for (int j = 0  - 0, e = 2048 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_bucket)[j];
  ...
  tcl_file.set_num(2048, &tcl_file.bucket_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_bucket, __xlx_sprintf_buffer.data());
}
unsigned __xlx_offset_byte_param_sum = 0;
// print sum Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_sum, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_sum = 0*4;
  if (__xlx_apatb_param_sum) {
    for (int j = 0  - 0, e = 128 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_sum)[j];
  ...
  tcl_file.set_num(128, &tcl_file.sum_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_sum, __xlx_sprintf_buffer.data());
}
...
ss_sort_hw_stub_wrapper(__xlx_apatb_param_a, __xlx_apatb_param_b, __xlx_apatb_param_bucket, __xlx_apatb_param_sum, __xlx_apatb_param_checkdata, __xlx_apatb_param_hercules_buffer_size);
...
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVOUT_bucket, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_bucket = 0*4;
  if (__xlx_apatb_param_bucket) {
    for (int j = 0  - 0, e = 2048 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_bucket)[j];
...
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVOUT_sum, __xlx_sprintf_buffer.data());
  {  __xlx_offset_byte_param_sum = 0*4;
  if (__xlx_apatb_param_sum) {
    for (int j = 0  - 0, e = 128 - 0; j != e; ++j) {
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_sum)[j];
