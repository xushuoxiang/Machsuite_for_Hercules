<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="sort_syn" top="ms_mergesort">
    <files>
        ...
        <file name="../../common/hercules.c" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="sort.c" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
    </files>
    <solutions>
