...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/nfs/home/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 314 "/nfs/home/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
__attribute__((sdx_kernel("gemm", 0))) void gemm( double m1[64*64], double m2[64*64], double prod[64*64] ){_ssdm_SpecArrayDimSize(m1, 4096);_ssdm_SpecArrayDimSize(m2, 4096);_ssdm_SpecArrayDimSize(prod, 4096);
...
#pragma HLS RESOURCE variable=mult core=Mul
# 14 "gemm.c"
