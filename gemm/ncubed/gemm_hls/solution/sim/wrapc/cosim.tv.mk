...
AUTOPILOT_ROOT := /nfs/home/tools/Xilinx/Vitis_HLS/2020.2
...
IFLAG += -fPIC
ifndef AP_GCC_PATH
  AP_GCC_PATH := /nfs/home/tools/Xilinx/Vitis_HLS/2020.2/tps/lnx64/gcc-6.2.0/bin
endif
...
$(ObjDir)/harness.c_pre.c.tb.o : harness.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) harness.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/gemm.c_pre.c.tb.o : gemm.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) gemm.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
