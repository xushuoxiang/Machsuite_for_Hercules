set moduleName update_weights_1_Pipeline_VITIS_LOOP_169_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {update_weights.1_Pipeline_VITIS_LOOP_169_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ d_biases1 double 64 regular {array 64 { 1 3 } 1 1 }  }
	{ biases1 int 64 regular {array 64 { 0 1 } 1 1 }  }
	{ bias_norm_1_out double 64 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "d_biases1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bias_norm_1_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ d_biases1_address0 sc_out sc_lv 6 signal 0 } 
	{ d_biases1_ce0 sc_out sc_logic 1 signal 0 } 
	{ d_biases1_q0 sc_in sc_lv 64 signal 0 } 
	{ biases1_address0 sc_out sc_lv 6 signal 1 } 
	{ biases1_ce0 sc_out sc_logic 1 signal 1 } 
	{ biases1_we0 sc_out sc_logic 1 signal 1 } 
	{ biases1_d0 sc_out sc_lv 64 signal 1 } 
	{ biases1_address1 sc_out sc_lv 6 signal 1 } 
	{ biases1_ce1 sc_out sc_logic 1 signal 1 } 
	{ biases1_q1 sc_in sc_lv 64 signal 1 } 
	{ bias_norm_1_out sc_out sc_lv 64 signal 2 } 
	{ bias_norm_1_out_ap_vld sc_out sc_logic 1 outvld 2 } 
	...
	{ grp_fu_377_p_dout0 sc_in sc_lv 64 signal -1 } 
	...
	{ grp_fu_381_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bias_norm_1_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "bias_norm_1_out", "role": "default" }} , 
 	{ "name": "bias_norm_1_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "bias_norm_1_out", "role": "ap_vld" }} , 
 	...
 	{ "name": "grp_fu_377_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_377_p_dout0", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_381_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_381_p_dout0", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	bias_norm_1_out { ap_vld {  { bias_norm_1_out out_data 1 64 }  { bias_norm_1_out_ap_vld out_vld 1 1 } } }
}
