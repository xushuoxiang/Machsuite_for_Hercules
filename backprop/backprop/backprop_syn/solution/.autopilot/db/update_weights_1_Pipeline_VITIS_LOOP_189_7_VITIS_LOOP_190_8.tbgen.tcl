set moduleName update_weights_1_Pipeline_VITIS_LOOP_189_7_VITIS_LOOP_190_8
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {update_weights.1_Pipeline_VITIS_LOOP_189_7_VITIS_LOOP_190_8}
set C_modelType { void 0 }
set C_modelArgList {
	{ d_weights2 double 64 regular {array 4096 { 1 3 } 1 1 }  }
	{ weights2 int 64 regular {array 4096 { 0 1 } 1 1 }  }
	{ norm_4_out double 64 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "d_weights2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "norm_4_out", "interface" : "wire", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ d_weights2_address0 sc_out sc_lv 12 signal 0 } 
	{ d_weights2_ce0 sc_out sc_logic 1 signal 0 } 
	{ d_weights2_q0 sc_in sc_lv 64 signal 0 } 
	...
	{ norm_4_out sc_out sc_lv 64 signal 2 } 
	{ norm_4_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "norm_4_out", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "norm_4_out", "role": "default" }} , 
 	{ "name": "norm_4_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "norm_4_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dadddsub_64ns_64ns_64_5_full_dsp_1_U502", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "16403", "Max" : "16403"}
	, {"Name" : "Interval", "Min" : "16403", "Max" : "16403"}
]}
...
set Spec2ImplPortList { 
	...
	norm_4_out { ap_vld {  { norm_4_out out_data 1 64 }  { norm_4_out_ap_vld out_vld 1 1 } } }
}
