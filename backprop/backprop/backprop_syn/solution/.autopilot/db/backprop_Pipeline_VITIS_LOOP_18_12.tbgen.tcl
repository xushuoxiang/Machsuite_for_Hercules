set moduleName backprop_Pipeline_VITIS_LOOP_18_12
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {backprop_Pipeline_VITIS_LOOP_18_12}
set C_modelType { void 0 }
set C_modelArgList {
	{ activations2 double 64 regular {array 64 { 0 1 } 1 1 }  }
	{ dactivations2 double 64 regular {array 64 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "activations2", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "dactivations2", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ activations2_address1 sc_out sc_lv 6 signal 0 } 
	{ activations2_ce1 sc_out sc_logic 1 signal 0 } 
	{ activations2_q1 sc_in sc_lv 64 signal 0 } 
	{ dactivations2_address0 sc_out sc_lv 6 signal 1 } 
	{ dactivations2_ce0 sc_out sc_logic 1 signal 1 } 
	{ dactivations2_we0 sc_out sc_logic 1 signal 1 } 
	{ dactivations2_d0 sc_out sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "activations2_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "activations2", "role": "address1" }} , 
 	{ "name": "activations2_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "activations2", "role": "ce1" }} , 
 	{ "name": "activations2_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "activations2", "role": "q1" }} , 
 	...
 	{ "name": "dactivations2_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "dactivations2", "role": "we0" }} , 
 	{ "name": "dactivations2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "dactivations2", "role": "d0" }} , 
...
set Spec2ImplPortList { 
	activations2 { ap_memory {  { activations2_address0 mem_address 1 6 }  { activations2_ce0 mem_ce 1 1 }  { activations2_we0 mem_we 1 1 }  { activations2_d0 mem_din 1 64 }  { activations2_address1 MemPortADDR2 1 6 }  { activations2_ce1 MemPortCE2 1 1 }  { activations2_q1 in_data 0 64 } } }
	dactivations2 { ap_memory {  { dactivations2_address0 mem_address 1 6 }  { dactivations2_ce0 mem_ce 1 1 }  { dactivations2_we0 mem_we 1 1 }  { dactivations2_d0 mem_din 1 64 } } }
}
