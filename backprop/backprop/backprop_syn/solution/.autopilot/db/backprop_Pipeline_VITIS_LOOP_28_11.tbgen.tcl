set moduleName backprop_Pipeline_VITIS_LOOP_28_11
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {backprop_Pipeline_VITIS_LOOP_28_11}
...
set portList { 
	...
	{ biases2_q0 sc_in sc_lv 64 signal 1 } 
...
set Spec2ImplPortList { 
	activations2 { ap_memory {  { activations2_address0 mem_address 1 6 }  { activations2_ce0 mem_ce 1 1 }  { activations2_we0 mem_we 1 1 }  { activations2_d0 mem_din 1 64 }  { activations2_address1 MemPortADDR2 1 6 }  { activations2_ce1 MemPortCE2 1 1 }  { activations2_q1 MemPortDOUT2 0 64 } } }
