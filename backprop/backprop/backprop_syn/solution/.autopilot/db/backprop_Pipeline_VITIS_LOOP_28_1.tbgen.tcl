set moduleName backprop_Pipeline_VITIS_LOOP_28_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {backprop_Pipeline_VITIS_LOOP_28_1}
...
set Spec2ImplPortList { 
	activations1 { ap_memory {  { activations1_address0 mem_address 1 6 }  { activations1_ce0 mem_ce 1 1 }  { activations1_we0 mem_we 1 1 }  { activations1_d0 mem_din 1 64 }  { activations1_address1 MemPortADDR2 1 6 }  { activations1_ce1 MemPortCE2 1 1 }  { activations1_q1 MemPortDOUT2 0 64 } } }
	biases1 { ap_memory {  { biases1_address0 mem_address 1 6 }  { biases1_ce0 mem_ce 1 1 }  { biases1_q0 mem_dout 0 64 } } }
}
