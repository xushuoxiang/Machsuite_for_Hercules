set moduleName update_weights_1_Pipeline_VITIS_LOOP_182_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {update_weights.1_Pipeline_VITIS_LOOP_182_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ biases1 int 64 regular {array 64 { 0 1 } 1 1 }  }
	{ bias_norm double 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "biases1", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "bias_norm", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ biases1_address0 sc_out sc_lv 6 signal 0 } 
	{ biases1_ce0 sc_out sc_logic 1 signal 0 } 
	{ biases1_we0 sc_out sc_logic 1 signal 0 } 
	{ biases1_d0 sc_out sc_lv 64 signal 0 } 
	{ biases1_address1 sc_out sc_lv 6 signal 0 } 
	{ biases1_ce1 sc_out sc_logic 1 signal 0 } 
	{ biases1_q1 sc_in sc_lv 64 signal 0 } 
	{ bias_norm sc_in sc_lv 64 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bias_norm", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "bias_norm", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_22_no_dsp_1_U499", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	bias_norm { ap_none {  { bias_norm in_data 0 64 } } }
}
