set moduleName update_weights_1_Pipeline_VITIS_LOOP_177_4_VITIS_LOOP_178_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {update_weights.1_Pipeline_VITIS_LOOP_177_4_VITIS_LOOP_178_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ weights1 int 64 regular {array 832 { 0 1 } 1 1 }  }
	{ norm_1 double 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weights1", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "norm_1", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ norm_1 sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "norm_1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "norm_1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "857", "Max" : "857"}
	, {"Name" : "Interval", "Min" : "857", "Max" : "857"}
]}
...
set Spec2ImplPortList { 
	...
	norm_1 { ap_none {  { norm_1 in_data 0 64 } } }
}
