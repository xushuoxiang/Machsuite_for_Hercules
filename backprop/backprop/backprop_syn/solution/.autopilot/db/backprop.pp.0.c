...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 316 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 1 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 1 3 4
# 62 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 34 "/usr/include/stdio.h" 2 3 4


# 1 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 1 3 4
# 30 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
...
# 1 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 1 3 4
# 90 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
typedef int wchar_t;
...
# 1 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/inttypes.h" 1 3
# 30 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/inttypes.h" 3
# 1 "/usr/include/inttypes.h" 1 3 4
# 27 "/usr/include/inttypes.h" 3 4
# 1 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 1 3 4
# 63 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 3 4
...
# 64 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 2 3 4
...
extern uintmax_t wcstoumax (const __gwchar_t *__restrict __nptr,
       __gwchar_t ** __restrict __endptr, int __base)
     __attribute__ ((__nothrow__ ));
# 31 "/nfs/tools/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/inttypes.h" 2 3
...
# 5 "./backprop.h" 2
# 25 "./backprop.h"
__attribute__((sdx_kernel("backprop", 0))) void backprop(
    double weights1[13*64],
...
void soft_max(double net_outputs[3], double activations[3]) {
    ...
    VITIS_LOOP_8_1: for(i=0; i < 3; i++) {
        sum += exp(-activations[i]);
    }
    VITIS_LOOP_11_2: for(i=0; i < 3; i++) {
...
void RELU(double activations[64], double dactivations[64], int size) {
    int i;
    VITIS_LOOP_18_1: for( i = 0; i < size; i++) {
...
void add_bias_to_activations(double biases[64],
                               ...
                               int size) {
    int i;
    VITIS_LOOP_28_1: for( i = 0; i < size; i++){
...
void matrix_vector_product_with_bias_input_layer(double biases[64],
    ...
    int i,j;
    VITIS_LOOP_38_1: for(j = 0; j < 64; j++){
        activations[j] = (double)0.0;
        VITIS_LOOP_40_2: for (i = 0; i < 13; i++){
...
void matrix_vector_product_with_bias_second_layer(double biases[64],
    ...
    int i,j;
    VITIS_LOOP_52_1: for (i = 0; i < 64; i++){
        activations[i] = (double)0.0;
        VITIS_LOOP_54_2: for(j = 0; j < 64; j++){
...
void matrix_vector_product_with_bias_output_layer(double biases[3],
                                                 ...
                                                 double input_activations[64]){
    int i, j;
    VITIS_LOOP_66_1: for(j = 0; j < 3; j++){
        activations[j] = (double)0.0;
        VITIS_LOOP_68_2: for (i = 0; i < 64; i++){
...
void get_delta_matrix_weights3(double delta_weights3[64*3],
    ...
    int i, j;
    VITIS_LOOP_89_1: for( i = 0; i < 64; i++) {
        VITIS_LOOP_90_2: for( j = 0; j < 3; j++) {
...
void get_oracle_activations2(double weights3[64*3],
    ...
    int i, j;
    VITIS_LOOP_101_1: for( i = 0; i < 64; i++) {
        oracle_activations[i] = (double)0.0;
        VITIS_LOOP_103_2: for( j = 0; j < 3; j++) {
...
void get_delta_matrix_weights2(double delta_weights2[64*64],
                               ...
                               double last_activations[64]) {
    int i, j;
    VITIS_LOOP_114_1: for( i = 0; i < 64; i++) {
        VITIS_LOOP_115_2: for( j = 0; j < 64; j++) {
...
void get_oracle_activations1(double weights2[64*64],
    ...
    VITIS_LOOP_126_1: for( i = 0; i < 64; i++) {
        oracle_activations[i] = (double)0.0;
        VITIS_LOOP_128_2: for( j = 0; j < 64; j++) {
...
void get_delta_matrix_weights1(double delta_weights1[13*64],
    ...
    int i, j;
    VITIS_LOOP_139_1: for( i = 0; i < 13; i++) {
        VITIS_LOOP_140_2: for( j = 0; j < 64; j++) {
...
void update_weights(double weights1[13*64],
    ...
    VITIS_LOOP_163_1: for(i=0; i < 13; i++){
        VITIS_LOOP_164_2: for(j = 0; j < 64; j++){
            weights1[i*64 + j] -= (d_weights1[i*64 + j] * 0.01);
            norm += weights1[i*64 + j]*weights1[i*64 + j];
        }
    }
    VITIS_LOOP_169_3: for(i=0; i < 64; i++){
    ...
    VITIS_LOOP_177_4: for(i=0; i < 13; i++){
        VITIS_LOOP_178_5: for(j = 0; j < 64; j++){
            weights1[i*64 + j] = (weights1[i*64 + j]/norm);
        }
    }
    VITIS_LOOP_182_6: for(i=0; i < 64; i++){
    ...
    VITIS_LOOP_189_7: for(i=0; i < 64; i++){
        VITIS_LOOP_190_8: for(j = 0; j < 64; j++){
            weights2[i*64 + j] -= (d_weights2[i*64 + j] * 0.01);
            norm += weights2[i*64 + j]*weights2[i*64 + j];
        }
    }
    VITIS_LOOP_195_9: for(i=0; i < 64; i++){
    ...
    VITIS_LOOP_203_10: for(i=0; i < 64; i++){
        VITIS_LOOP_204_11: for(j = 0; j < 64; j++){
            weights2[i*64 + j] = (weights2[i*64 + j]/norm);
        }
    }
    VITIS_LOOP_208_12: for(i=0; i < 64; i++){
    ...
    VITIS_LOOP_215_13: for(i=0; i < 64; i++){
        VITIS_LOOP_216_14: for(j = 0; j < 3; j++){
            weights3[i*3 + j] -= (d_weights3[i*3 + j] * 0.01);
            norm += weights3[i*3 + j]*weights3[i*3 + j];
        }
    }
    VITIS_LOOP_221_15: for(i=0; i<3;i++){
    ...
    VITIS_LOOP_229_16: for(i=0; i < 64; i++){
        VITIS_LOOP_230_17: for(j = 0; j < 3; j++){
            weights3[i*3 + j] = (weights3[i*3 + j]/norm);
        }
    }
    VITIS_LOOP_234_18: for(i=0; i < 3; i++){
        biases3[i] = (biases3[i]/bias_norm);
    }
}

__attribute__((sdx_kernel("backprop", 0))) void backprop(double weights1[13*64],
                double weights2[64*64],
                double weights3[64*3],
                double biases1[64],
                double biases2[64],
                ...
                double training_data[163*13],
                double training_targets[163*3]) {
#line 21 "/nfs/home/xushuoxiang/Machsuite_V0.1/backprop/backprop/backprop_syn/solution/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=backprop
# 246 "backprop.c"
    ...
    VITIS_LOOP_264_1: for(i=0; i<163; i++){
        VITIS_LOOP_265_2: for(j=0;j<64;j++){
