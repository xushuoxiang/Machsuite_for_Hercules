set moduleName backprop_Pipeline_VITIS_LOOP_89_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {backprop_Pipeline_VITIS_LOOP_89_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ activations2 double 64 regular {array 64 { 1 3 } 1 1 }  }
	{ output_difference_0_1_reload double 64 regular  }
	{ delta_weights3 double 64 regular {array 192 { 0 0 } 0 1 }  }
	{ output_difference_1_1_reload double 64 regular  }
	{ output_difference_2_1_reload double 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "activations2", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ activations2_q0 sc_in sc_lv 64 signal 0 } 
	{ output_difference_0_1_reload sc_in sc_lv 64 signal 1 } 
	{ delta_weights3_address0 sc_out sc_lv 8 signal 2 } 
	{ delta_weights3_ce0 sc_out sc_logic 1 signal 2 } 
	{ delta_weights3_we0 sc_out sc_logic 1 signal 2 } 
	{ delta_weights3_d0 sc_out sc_lv 64 signal 2 } 
	{ delta_weights3_address1 sc_out sc_lv 8 signal 2 } 
	{ delta_weights3_ce1 sc_out sc_logic 1 signal 2 } 
	{ delta_weights3_we1 sc_out sc_logic 1 signal 2 } 
	{ delta_weights3_d1 sc_out sc_lv 64 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "activations2_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "activations2", "role": "q0" }} , 
 	...
 	{ "name": "delta_weights3_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "delta_weights3", "role": "address1" }} , 
 	{ "name": "delta_weights3_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "delta_weights3", "role": "ce1" }} , 
 	{ "name": "delta_weights3_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "delta_weights3", "role": "we1" }} , 
 	{ "name": "delta_weights3_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "delta_weights3", "role": "d1" }} , 
...
set Spec2ImplPortList { 
	activations2 { ap_memory {  { activations2_address0 mem_address 1 6 }  { activations2_ce0 mem_ce 1 1 }  { activations2_q0 mem_dout 0 64 } } }
	output_difference_0_1_reload { ap_none {  { output_difference_0_1_reload in_data 0 64 } } }
	delta_weights3 { ap_memory {  { delta_weights3_address0 mem_address 1 8 }  { delta_weights3_ce0 mem_ce 1 1 }  { delta_weights3_we0 mem_we 1 1 }  { delta_weights3_d0 mem_din 1 64 }  { delta_weights3_address1 MemPortADDR2 1 8 }  { delta_weights3_ce1 MemPortCE2 1 1 }  { delta_weights3_we1 MemPortWE2 1 1 }  { delta_weights3_d1 MemPortDIN2 1 64 } } }
