set moduleName update_weights_1_Pipeline_VITIS_LOOP_234_18
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {update_weights.1_Pipeline_VITIS_LOOP_234_18}
set C_modelType { void 0 }
set C_modelArgList {
	{ biases3 int 64 regular {array 3 { 0 1 } 1 1 }  }
	{ bias_norm_6 double 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "biases3", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "bias_norm_6", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ biases3_we0 sc_out sc_logic 1 signal 0 } 
	{ biases3_d0 sc_out sc_lv 64 signal 0 } 
	{ biases3_address1 sc_out sc_lv 2 signal 0 } 
	{ biases3_ce1 sc_out sc_logic 1 signal 0 } 
	{ biases3_q1 sc_in sc_lv 64 signal 0 } 
	{ bias_norm_6 sc_in sc_lv 64 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bias_norm_6", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "bias_norm_6", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddiv_64ns_64ns_64_22_no_dsp_1_U534", "Parent" : "0"},
...
set Spec2ImplPortList { 
	biases3 { ap_memory {  { biases3_address0 mem_address 1 2 }  { biases3_ce0 mem_ce 1 1 }  { biases3_we0 mem_we 1 1 }  { biases3_d0 mem_din 1 64 }  { biases3_address1 MemPortADDR2 1 2 }  { biases3_ce1 MemPortCE2 1 1 }  { biases3_q1 MemPortDOUT2 0 64 } } }
	bias_norm_6 { ap_none {  { bias_norm_6 in_data 0 64 } } }
}
